...
public class MySQL {
    ...
    public boolean connect() {
        try {
            ...
            CoinAPI.getInstance().printToConsole("§cKonnte nicht zur MySQL-Datenbank verbinden: " + e.getMessage());
    ...
    public void close() {
        try {
            ...
            CoinAPI.getInstance().printToConsole("§cVerbindung zur MySQL-Datenbank konnte nicht beendet werden.");
        }
    }
